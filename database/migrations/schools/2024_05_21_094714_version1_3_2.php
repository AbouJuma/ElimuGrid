...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $usersTable = 'users';
        try {
            Schema::create('certificate_templates', static function (Blueprint $table) use ($schoolsTable) {
                $table->id();
                $table->string('name');
        ...
        try {
            Schema::table('faqs', static function (Blueprint $table) use ($schoolsTable) {
                $table->foreignId('school_id')->after('description')->nullable(true)->references('id')->on($schoolsTable)->onDelete('cascade');
            });
        } catch (\Exception $e) {}
        ...
        try {
            Schema::create('class_groups', static function (Blueprint $table) use ($schoolsTable) {
                $table->id();
        ...
        try {
            Schema::create('payroll_settings', function (Blueprint $table) use ($schoolsTable) {
                $table->id();
                $table->string('name');
        ...
        try {
            Schema::create('staff_payrolls', function (Blueprint $table) use ($schoolsTable) {
                $table->id();
