...
<style>
    :root {
        /* Elimu Grid Brand Colors */
        --primary-color: {{ $settings['theme_primary_color'] ?? '#d69e2e' }};
        --secondary-color: {{ $settings['theme_secondary_color'] ?? '#1a365d' }};
        --secondary-color1: {{ $settings['theme_secondary_color_1'] ?? '#2c5282' }};
        --primary-background-color: {{ $settings['theme_primary_background_color'] ?? '#f7fafc' }};
        --text--secondary-color: {{ $settings['theme_text_secondary_color'] ?? '#4a5568' }};
    }
    
    /* Elimu Grid Brand Typography */
    body {
        font-family: 'Inter', sans-serif !important;
    }
    
    h1, h2, h3, h4, h5, h6, .commonTitle, .sectionTitle span, .title {
    ...
    <div class="container">
        <div class="navbarWrapper">
            <div class="navLogoWrapper">
                <div class="navLogo">
                    <a href="{{ url('/') }}">
                        <img src="{{ $settings['horizontal_logo'] ?? asset('images/elimugrid/elogo.png') }}" class="logo" alt="ElimuGrid">
                    </a>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
            ...
            <div class="offcanvas-header">
                <div class="navLogoWrapper">
                    <div class="navLogo">
                        <img src="{{ $settings['horizontal_logo'] ?? asset('images/elimugrid/elogo.png') }}" alt="ElimuGrid">
                    </div>
                </div>
...
<div class="main">
    ...
    <section class="hero-slider-section" id="home">
        <div class="hero-slider">
            <!-- Slide 1 - Academic Management -->
            <div class="hero-slide" style="background-image: url('{{ $settings['hero_slide_1_image'] ?? asset('images/elimugrid/academic.png') }}')">
                <div class="hero-overlay"></div>
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="hero-content">
                                <span class="hero-subtitle">ElimuGrid - School Management System</span>
                                <h1 class="hero-title">Academic Management</h1>
                                <p class="hero-description">Transform School Management With ElimuGrid. Experience the future of education with our platform. Streamline attendance, assignments, exams, and more.</p>
                                <div class="hero-buttons">
                                    <button class="hero-btn hero-btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">{{ __('register_your_school') }} <i class="fas fa-chevron-right"></i></button>
                                    @if ($isDemoSchool == 1)
                                        <a href="{{ $demoSchoolUrl ?? url('/') }}" target="_blank" class="hero-btn hero-btn-secondary">{{ __('demo_school') }} <i class="fas fa-chevron-right"></i></a>
                                    @else
                                        <a href="#contact-us" class="hero-btn hero-btn-secondary">{{ __('contact') }} <i class="fas fa-chevron-right"></i></a>
                                    @endif
                                </div>
                            </div>
                        </div>
            ...
            <div class="hero-slide" style="background-image: url('{{ $settings['hero_slide_2_image'] ?? asset('images/elimugrid/human_resoure.jpg') }}')">
                <div class="hero-overlay"></div>
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="hero-content">
                                <span class="hero-subtitle">ElimuGrid - School Management System</span>
                                <h1 class="hero-title">Staff Management</h1>
                                <p class="hero-description">Efficiently manage your teaching and non-teaching staff. HR, payroll, performance tracking, leave management, and staff documentation all in one place.</p>
                                <div class="hero-buttons">
                                    <button class="hero-btn hero-btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">{{ __('register_your_school') }} <i class="fas fa-chevron-right"></i></button>
                                    @if ($isDemoSchool == 1)
                                        <a href="{{ $demoSchoolUrl ?? url('/') }}" target="_blank" class="hero-btn hero-btn-secondary">{{ __('demo_school') }} <i class="fas fa-chevron-right"></i></a>
            ...
            <div class="hero-slide" style="background-image: url('{{ $settings['hero_slide_3_image'] ?? asset('images/elimugrid/finance.jpg') }}')">
                <div class="hero-overlay"></div>
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="hero-content">
                                <span class="hero-subtitle">ElimuGrid - School Management System</span>
                                <h1 class="hero-title">Financial Management</h1>
                                <p class="hero-description">Complete fee collection, accounting, invoicing, reporting, and forecasting. Simplify your school's financial operations with our comprehensive tools.</p>
                                <div class="hero-buttons">
                                    <button class="hero-btn hero-btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">{{ __('register_your_school') }} <i class="fas fa-chevron-right"></i></button>
                                    @if ($isDemoSchool == 1)
                                        <a href="{{ $demoSchoolUrl ?? url('/') }}" target="_blank" class="hero-btn hero-btn-secondary">{{ __('demo_school') }} <i class="fas fa-chevron-right"></i></a>
    ...
    <section class="features-section commonMT" id="features">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center mb-5">
                    <span class="section-subtitle">{{ __('our_services') }}</span>
                    <h2 class="section-heading">{{ __('explore_our_top_features') }}</h2>
                    <p class="section-description">Comprehensive tools designed to streamline your educational institution management</p>
                </div>
            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="feature-card">
                                <div class="feature-icon-wrapper">
                                    <img src="{{ asset('assets/landing_page_images/features/') }}/{{ $feature->name }}.svg" alt="{{ __($feature->name) }}">
                                </div>
                                <div class="feature-content">
                                    <h4>{{ __($feature->name) }}</h4>
                                    <p>{{ __($feature->name . '_desc') }}</p>
                                    <a href="#" class="feature-link">{{ __('learn_more') }} <i class="fas fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    @else
                        <div class="col-lg-4 col-md-6 mb-4 default-feature-list" style="display: none">
                            <div class="feature-card">
                                <div class="feature-icon-wrapper">
                                    <img src="{{ asset('assets/landing_page_images/features/') }}/{{ $feature->name }}.svg" alt="{{ __($feature->name) }}">
                                </div>
  ...
  <!-- School logos section ends here -->
    ...
    <section class="whyBest container commonMT" id="about-us">
        <div class="row">
            <div class="col-lg-6">
                <img src="{{ $settings['about_us_image'] ?? asset('images/elimugrid/Best.png') }}" alt="">
            </div>
                            ...
                            <div class="col-lg-6 infoBox">
                                ...
                                <div class="infoWrapper">
                                    ...
                                    <div>
                                        ...
                                        <span>{{ $settings['address'] ?? 'Victoria House, Dar es Salaam' }}</span>
                                    </div>
                                </div>
                                <div>
    ...
    <section class="ourApp container commonMT">
        <div class="row">
            <div class="col-lg-6">
                <img src="{{ $settings['download_our_app_image'] ?? asset('images/elimugrid/phones.png') }}" class="ourAppImg" alt="">
            </div>
