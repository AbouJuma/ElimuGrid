                            ...
                            <div class="clearfix">
                                ...
                                <div id="step-2" class="step-form">
                                    <form id="formdata" class="edit-form" action="{{route('notification-setting.update')}}" method="POST" novalidate="novalidate">
                                        ...
                                        <input class="btn btn-warning float-right ml-3 btn-skip-notification" type="button" value="{{ __('Skip for Now') }}">
...
<script>
    $(document).ready(function() {
        ...
        // Specific handler for notification skip button
        $('.btn-skip-notification').on('click', function(e) {
            e.preventDefault();
            // Mark notification step as complete even when skipped
            handleStepCompletion(currentFormIndex, null);
        });
