...
class SystemSettingsController extends Controller {
    ...
    public function store(Request $request) {
        ...
        $request->validate([
            ...
            'login_page_logo' => 'nullable|mimes:jpg,png,jpeg,svg'
        ]);
        ...
        try {
            ...
            // Check if .env file is writable before trying to update it
            ...
            if (file_exists($envPath) && is_writable($envPath)) {
                try {
                    ...
                    // Log env error but continue with database update
                    Log::error('Failed to update .env file: ' . $envError->getMessage());
                }
            } else {
                Log::warning('.env file is not writable. Skipping environment variable updates.');
            }
    ...
    public function notificationSettingUpdate(Request $request)
    {
        ...
        if( $request->file('firebase_service_file') != null) {
            ...
            if ($configData === null) {
                ResponseService::errorResponse('The Firebase service file is not a valid JSON file');
            }
