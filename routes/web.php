...
Route::group(['middleware' => ['Role', 'checkSchoolStatus', 'status','SwitchDatabase','verifiedEmail','CheckForMaintenanceMode','2fa','wizardSettings']], static function () {
    ...
    Route::group(['middleware' => 'language'], static function () {
        ...
        Route::group(['prefix' => 'attendance'], static function () {
            ...
            Route::get('scan', [AttendanceController::class, 'scanAttendance'])->name('attendance.scan');
            Route::post('mark-by-barcode', [AttendanceController::class, 'markAttendanceByBarcode'])->name('attendance.mark-by-barcode');
        });
        ...
        /*** Library Management ***/
        Route::group(['prefix' => 'library'], static function () {
            // Books Management
            Route::get('books', [BookController::class, 'index'])->name('library.books.index');
            Route::get('books/list', [BookController::class, 'getBooks'])->name('library.books.list');
            Route::post('books', [BookController::class, 'store'])->name('library.books.store');
            Route::get('books/{id}/edit', [BookController::class, 'edit'])->name('library.books.edit');
            Route::put('books/{id}', [BookController::class, 'update'])->name('library.books.update');
            Route::delete('books/{id}', [BookController::class, 'destroy'])->name('library.books.destroy');
            Route::get('books/search', [BookController::class, 'search'])->name('library.books.search');

            // Book Issues Management
            Route::get('issues', [BookIssueController::class, 'index'])->name('library.issues.index');
            Route::get('issues/borrowed', [BookIssueController::class, 'getBorrowedBooks'])->name('library.issues.borrowed');
            // Test route to bypass controller
            Route::get('issues/test', function() {
                return response()->json([
                    'test' => 'Direct route works',
                    'time' => now(),
                    'user' => auth()->user() ? auth()->user()->email : 'guest'
                ]);
            })->name('library.issues.test');
            Route::get('issues/returned', [BookIssueController::class, 'getReturnedBooks'])->name('library.issues.returned');
            Route::get('issues/overdue', [BookIssueController::class, 'getOverdueBooks'])->name('library.issues.overdue');
            Route::post('issues', [BookIssueController::class, 'store'])->name('library.issues.store');
            Route::post('issues/{id}/return', [BookIssueController::class, 'returnBook'])->name('library.issues.return');
            Route::get('issues/get-students', [BookIssueController::class, 'getStudentsByClass'])->name('library.issues.get-students');

            // Reports
            Route::get('reports', [BookIssueController::class, 'reports'])->name('library.reports');
        });

        /*** Hostel Management ***/
        Route::group(['prefix' => 'hostel'], static function () {
            // Hostels Management
            Route::get('hostels', [HostelController::class, 'index'])->name('hostel.hostels.index');
            Route::get('hostels/list', [HostelController::class, 'getHostels'])->name('hostel.hostels.list');
            Route::post('hostels', [HostelController::class, 'store'])->name('hostel.hostels.store');
            Route::get('hostels/{id}/edit', [HostelController::class, 'edit'])->name('hostel.hostels.edit');
            Route::put('hostels/{id}', [HostelController::class, 'update'])->name('hostel.hostels.update');
            Route::delete('hostels/{id}', [HostelController::class, 'destroy'])->name('hostel.hostels.destroy');

            // Rooms Management
            Route::get('rooms', [RoomController::class, 'index'])->name('hostel.rooms.index');
            Route::get('rooms/list', [RoomController::class, 'getRooms'])->name('hostel.rooms.list');
            Route::post('rooms', [RoomController::class, 'store'])->name('hostel.rooms.store');
            Route::get('rooms/{id}/edit', [RoomController::class, 'edit'])->name('hostel.rooms.edit');
            Route::put('rooms/{id}', [RoomController::class, 'update'])->name('hostel.rooms.update');
            Route::delete('rooms/{id}', [RoomController::class, 'destroy'])->name('hostel.rooms.destroy');
            Route::get('rooms/by-hostel', [RoomController::class, 'getRoomsByHostel'])->name('hostel.rooms.by.hostel');
            Route::get('rooms/available', [RoomController::class, 'getAvailableRooms'])->name('hostel.rooms.available');

            // Allocations Management
            Route::get('allocations', [HostelAllocationController::class, 'index'])->name('hostel.allocations.index');
            Route::get('allocations/list', [HostelAllocationController::class, 'getAllocations'])->name('hostel.allocations.list');
            Route::post('allocations', [HostelAllocationController::class, 'store'])->name('hostel.allocations.store');
            Route::post('allocations/checkout/{id}', [HostelAllocationController::class, 'checkOut'])->name('hostel.allocations.checkout');
            Route::delete('allocations/{id}', [HostelAllocationController::class, 'destroy'])->name('hostel.allocations.destroy');
            Route::get('students-by-class', [HostelAllocationController::class, 'getStudentsByClass'])->name('students.by.class');

            // Reports
            Route::get('reports', [HostelAllocationController::class, 'reports'])->name('hostel.reports');
            Route::get('reports/occupancy', [HostelAllocationController::class, 'getOccupancyReport'])->name('hostel.reports.occupancy');
        });

        /*** Transport Management ***/
        Route::group(['prefix' => 'transport'], static function () {
            // Routes Management
            Route::get('routes', [TransportRouteController::class, 'index'])->name('transport.routes.index');
            Route::get('routes/list', [TransportRouteController::class, 'getRoutes'])->name('transport.routes.list');
            Route::post('routes', [TransportRouteController::class, 'store'])->name('transport.routes.store');
            Route::get('routes/{id}', [TransportRouteController::class, 'show'])->name('transport.routes.show');
            Route::put('routes/{id}', [TransportRouteController::class, 'update'])->name('transport.routes.update');
            Route::delete('routes/{id}', [TransportRouteController::class, 'destroy'])->name('transport.routes.destroy');
            Route::get('routes/dropdown/all', [TransportRouteController::class, 'getRoutesDropdown'])->name('transport.routes.dropdown');

            // Stops Management
            Route::get('stops/by-route', [TransportAllocationController::class, 'getStopsByRoute'])->name('transport.stops.by.route');
            Route::post('stops', [TransportAllocationController::class, 'storeStop'])->name('transport.stops.store');

            // Allocations Management
            Route::get('allocations', [TransportAllocationController::class, 'index'])->name('transport.allocations.index');
            Route::get('allocations/list', [TransportAllocationController::class, 'getAllocations'])->name('transport.allocations.list');
            Route::post('allocations', [TransportAllocationController::class, 'store'])->name('transport.allocations.store');
            Route::put('allocations/{id}', [TransportAllocationController::class, 'update'])->name('transport.allocations.update');
            Route::post('allocations/{id}/terminate', [TransportAllocationController::class, 'terminate'])->name('transport.allocations.terminate');
            Route::delete('allocations/{id}', [TransportAllocationController::class, 'destroy'])->name('transport.allocations.destroy');
            
            // Fee Generation
            Route::post('fees/generate', [TransportAllocationController::class, 'generateFees'])->name('transport.fees.generate');
            Route::post('fees/mark-paid/{id}', [TransportAllocationController::class, 'markFeePaid'])->name('transport.fees.mark-paid');
            
            // Students
            Route::get('students/available', [TransportAllocationController::class, 'getAvailableStudents'])->name('transport.students.available');

            // Reports
            Route::get('reports/fee-collection', [TransportReportController::class, 'feeCollection'])->name('transport.reports.fee_collection');
            Route::get('reports/fee-collection-data', [TransportReportController::class, 'getFeeCollectionData'])->name('transport.reports.fee_collection.data');
            Route::get('reports/route-revenue', [TransportReportController::class, 'routeRevenue'])->name('transport.reports.route_revenue');
            Route::get('reports/route-revenue-data', [TransportReportController::class, 'getRouteRevenueData'])->name('transport.reports.route_revenue.data');
            Route::get('reports/unpaid-fees', [TransportReportController::class, 'unpaidFees'])->name('transport.reports.unpaid_fees');
            Route::get('reports/unpaid-fees-data', [TransportReportController::class, 'getUnpaidFeesData'])->name('transport.reports.unpaid_fees.data');
            Route::get('reports/student-statement', [TransportReportController::class, 'studentStatement'])->name('transport.reports.student_statement');
            Route::get('reports/dashboard-stats', [TransportReportController::class, 'dashboardStats'])->name('transport.reports.dashboard_stats');
        });
        ...
        Route::get('reports/student/student-view-reports/{id}', [ReportsController::class, 'student_view_reports'])->name('reports.student.student-view-reports');
        ...
        // Exam Reports
        Route::get('reports/exam/exam-reports', [ReportsController::class, 'exam_reports'])->name('reports.exam.exam-reports');
        Route::get('reports/exam/exam-reports/show', [ReportsController::class, 'exam_reports_show'])->name('reports.exam.exam-reports.show');
        Route::get('reports/exam/exam-view-reports/{id}', [ReportsController::class, 'exam_view_reports'])->name('reports.exam.exam-view-reports');
        
        // Yearly Results
        Route::get('reports/exam/yearly-result-show', [ReportsController::class, 'yearlyResultShow'])->name('reports.exam.yearly-result-show');
        Route::get('reports/exam/yearly-result-show/{id}', [ReportsController::class, 'yearlyResultShow'])->name('reports.exam.yearly-result-show');
        Route::get('reports/exam/yearly-result/{student_id}', [ReportsController::class, 'yearlyExamResultPdf'])->name('reports.exam.yearly-result-pdf');
        Route::get('reports/exam/yearly-result-statistics', [ReportsController::class, 'yearlyResultStatistics'])->name('reports.exam.yearly-result-statistics');
        Route::get('reports/exam/yearly-result/bulk-exam-result', [ReportsController::class, 'bulkExamResult'])->name('reports.exam.bulk-exam-result');

        // Subject Wise Results
        Route::get('reports/exam/subject-wise-result-show', [ReportsController::class, 'subjectWiseResultShow'])->name('reports.exam.subject-wise-result-show');
        Route::get('reports/exam/subject-wise-result-show/{id}', [ReportsController::class, 'subjectWiseResultShow'])->name('reports.exam.subject-wise-result');
        Route::get('reports/exam/subject-wise-result/{student_id}', [ReportsController::class, 'subjectWiseResultPdf'])->name('reports.exam.subject-wise-result-pdf');
        Route::get('reports/exam/subject-wise-result-statistics', [ReportsController::class, 'subjectWiseResultStatistics'])->name('reports.exam.subject-wise-result-statistics');
        Route::get('reports/exam/subject-wise-result/bulk-subject-result', [ReportsController::class, 'bulkSubjectWiseResult'])->name('reports.exam.bulk-subject-result');

        // Rank Wise Results
        Route::get('reports/exam/rank-wise-result-show', [ReportsController::class, 'rankWiseResultShow'])->name('reports.exam.rank-wise-result-show');
        Route::get('reports/exam/rank-wise-result-show/{id}', [ReportsController::class, 'rankWiseResultShow'])->name('reports.exam.rank-wise-result');
        Route::get('reports/exam/rank-wise-result/{student_id}', [ReportsController::class, 'rankWiseResultPdf'])->name('reports.exam.rank-wise-result-pdf');
